...
export default () => {
    ...
    const getFormulario = () => {
        ...
        let pagamento = document.getElementById("selectCartao").value
        ...
        if (devolverFinalCartao(pagamento) == "dito") {
            id_tipo_cartao = 1;
        }
        else if (devolverFinalCartao(pagamento) == "bito") {
            id_tipo_cartao = 2;
            num_parcelas=0;
        }
        ...
        <>
            <div className="row justify-content-center mt-5">
                ...
                <div className="text-center col-md-5 col-sm-6 col-12 mb-md-0 mb-sm-0 mb-4 order-md-2 order-sm-2 order-1">
                    <a onClick={() => getFormulario()} href="#/checkout/resumo/1/1" className="avancar">Confirmar Dados</a>
                </div>
            </div>
        </>
    )

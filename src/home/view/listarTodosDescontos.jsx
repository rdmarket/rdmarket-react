...
export default class ListarTodosDescontos extends Component {
    ...
    obterDadosDeProduto(pageNumber = 1) {
        ...
        const url = `http://rdmarket-laravel.test/api/produtos/listarTodosDescontosPaginate/?page=${pageNumber}`;
    ...
    capturarFiltro = (n) => {
        ...
        const url = `http://rdmarket-laravel.test/api/produtos/listarTodosDescontosPaginate/?page=${this.state.pg}`;
        axios.get(url).then(resp => {
            // console.log(resp.data);
            ...
            return (
                <>
                    ...
                    <section className="container-alimentos">
                        <ListagemDesconto func={e => this.aumentarValor(e)} caminho={IMAGE_PATH} produtos={data} />
                        <Pagination

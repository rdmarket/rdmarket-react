...
const API_CARTAO = 'http://rdmarket-laravel.test/api/cartao/adicionarCartao/';
    ...
    const adicionarCartao = () => {
        ...
        axios.post(`${API_CARTAO}`, {
            ...
            .then(function (response) {
                swal("Cartão adicionado com sucesso!", "", "success")
                    .then((value) => {
                ...
                <div className="row justify-content-center">
                    <div className="col-9">
                        <div className="row justify-content-between">
                            ...
                            <div className="col-4">
                                <a type="button" className="btn btn-success" style={{ width: '100%' }} onClick={ () => adicionarCartao()}>Salvar</a>
                            </div>
                        </div>
                    </div>
                </div>
